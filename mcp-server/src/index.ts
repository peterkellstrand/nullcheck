...
if (!API_KEY) {
  console.error(
    'Error: NULLCHECK_API_KEY environment variable is required.\n' +
  ...
  try {
    switch (name) {
      case 'check_token_risk':
        return await handleCheckTokenRisk(client, args as Parameters<typeof handleCheckTokenRisk>[1]);

      case 'get_trending_tokens':
        return await handleGetTrendingTokens(client, args as Parameters<typeof handleGetTrendingTokens>[1]);

      case 'search_tokens':
        return await handleSearchTokens(client, args as Parameters<typeof handleSearchTokens>[1]);

      case 'get_whale_activity':
        return await handleGetWhaleActivity(client, args as Parameters<typeof handleGetWhaleActivity>[1]);

      case 'get_whale_holders':
        return await handleGetWhaleHolders(client, args as Parameters<typeof handleGetWhaleHolders>[1]);

      case 'batch_risk_check':
        return await handleBatchRiskCheck(client, args as Parameters<typeof handleBatchRiskCheck>[1]);

      case 'get_token_details':
        return await handleGetTokenDetails(client, args as Parameters<typeof handleGetTokenDetails>[1]);
